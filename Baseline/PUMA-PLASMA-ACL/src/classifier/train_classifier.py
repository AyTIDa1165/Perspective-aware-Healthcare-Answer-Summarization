...
if __name__=="__main__":
    ...
    TRAIN_BATCH_SIZE = 8
    with open(f'{root}/Dataset/train.json', 'r') as json_file:
        train_data = json.load(json_file)

    VALID_BATCH_SIZE = 4
    with open(f'{root}/Dataset/test.json', 'r') as json_file:
        valid_data = json.load(json_file)

    print(valid_data[0]['answers'][0])
    ...
    #             torch.save(state_dict, f"./classifier/best_ckpt_epoch={epoch}_valid_loss={round(best_loss, 4)}.ckpt")
